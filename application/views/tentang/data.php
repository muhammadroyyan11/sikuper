                    ...
                    <tr>
                        ...
                        <td class="text-center" width="160px">
                            <form action="<?= site_url('admin/jenisPerumahan/del') ?>" method="post">
                                <a href="<?= site_url('admin/jenisPerumahan/edit/' . $data->id_tentangKami) ?>" class="btn btn-warning btn-xs">
                                    <i class="fa fa-pencil"></i> Edit
                                </a>
                                <input type="hidden" name="id_tentangKami" value="<?= $data->id_tentangKami ?>">

                                <a href="<?= site_url('admin/jenisPerumahan/del/' . $data->id_tentangKami) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Apakah Anda Yakin ?')">
